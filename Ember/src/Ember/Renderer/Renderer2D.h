...
namespace Ember {
	...
	public:
		...
		static void DrawQuad(const glm::mat4& transform, const Ref<Texture2D>& texture, const float& tilingFactor = 1.0f, const glm::vec4& color = glm::vec4(1.0f), int entityID = -1);
		static void DrawQuad(const glm::mat4& transform, const Ref<SubTexture2D>& subTexture, const float& tilingFactor = 1.0f, const glm::vec4& color = glm::vec4(1.0f), int entityID = -1);
